...
<section class="portfolio-archieve">
	<?php
	$filter     = '[facetwp facet="portfolio_categories"]';
	...
	<div class="container">
		<div class="portfolio-archieve__info">
			...
			<?php endif; */?>
			<div class="portfolio-archieve__info__categories">
				<div class="facetwp-checkbox checked" data-value="all-projects">All Projects</div>
				<?php if ( $filter ) : ?>
