	...
	<div class="container">
		<?php if ( $gallery ) : ?>
			...
			<div class="services-gallery__item">
				<img src="<?php echo esc_attr( $image['url'] ); ?>" alt="" class="services-gallery__item__image">
...
<!-- Project Accordion -->
<section class="services-project" id="services">
	<?php
					...
					<div class="item-project">
						...
						if ( $projects ) :
							foreach ( $projects as $post ) :
								...
								?>
							<a href="<?php echo esc_url( the_permalink() ); ?>" class="item-project__item">
