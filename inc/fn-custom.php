...
// Ajax Portfolio
add_action( 'wp_ajax_loadAjaxPortfolio', 'loadAjaxPortfolio__handler' );
add_action( 'wp_ajax_nopriv_loadAjaxPortfolio', 'loadAjaxPortfolio__handler' );

function loadAjaxPortfolio__handler() {
	$cat = $_POST['ind'];
	ob_start();
	$args = array(
		'post_type'      => 'portfolio',
...
// Ajax News
add_action( 'wp_ajax_loadAjaxNews', 'loadAjaxNews__handler' );
add_action( 'wp_ajax_nopriv_loadAjaxNews', 'loadAjaxNews__handler' );

function loadAjaxNews__handler() {
	$cat = $_POST['ind'];
	ob_start();
	$args = array(
		'post_type'      => 'post',
